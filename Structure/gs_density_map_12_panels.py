...
times = [0.00, 0.14, 0.20, 0.23, 0.27, 0.34, 0.45, 0.57, 0.63, 0.74, 2.0, 5.0]  # in Gyr
dump_numbers = ["000", "014", "020", "023", "027", "034", "045", "057", "063", "074", "200", "500"]  # format "xxx"
...
picName = "density_map_12panels_"

# Set figure
fig, axes = plt.subplots(4, 3, sharex=True, sharey=True, constrained_layout=True, figsize=(11, 14))
...
cbar = fig.colorbar(im, ax=[axs[2], axs[11]], aspect=30)  # colorbar to the right of figure
