...
times = [0.20, 0.80, 1.50, 3.00, 4.00, 5.00]  # in Gyr
dump_numbers = ["000", "021", "060", "200", "350", "500"]  # format "xxx"
...
bound_stars = True  # if True, only plotting bound stars. If False, plotting every star.
...
axs = [axes[0, 0], axes[0, 1], axes[0, 2], axes[1, 0], axes[1, 1], axes[1, 2]]
...
cbar = fig.colorbar(im, ax=[axs[2], axs[5]], shrink=0.87, aspect=30)  # colorbar to the right of figure
...
# Save map
picName = picName + "_" + plan + "_" + dump_numbers[1] + "_" + str(xcut) + "kpc_" + str(nbins[0]) + "bins"
