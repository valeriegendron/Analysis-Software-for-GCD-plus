...
times = [0.00, 0.10, 0.20, 0.27, 0.32, 0.36, 0.40, 0.43, 0.60, 0.77, 0.81, 0.90, 0.99, 2.0, 5.0]  # in Gyr
dump_numbers = ["000", "010", "020", "027", "032", "036", "040", "043", "060", "077", "081", "090", "099", "200", "500"]  # format "xxx"
...
picName = "density_map_15panels_"

# Set figure
fig, axes = plt.subplots(5, 3, sharex=True, sharey=True, constrained_layout=True, figsize=(11, 17))
...
cbar = fig.colorbar(im, ax=[axs[2], axs[14]], aspect=30)  # colorbar to the right of figure
