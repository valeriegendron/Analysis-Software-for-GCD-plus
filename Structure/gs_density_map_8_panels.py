...
path = "/home/vgendron/projects/def-hmartel1/vgendron/RUNS/TIDES8_h_r2/diskev/"

times = [0.00, 0.50, 1.00, 1.08, 1.26, 1.50, 2.00, 5.00]  # in Gyr
dump_numbers = ["000", "050", "100", "108", "126", "150", "200", "500"]  # format "xxx"
...
picName = "density_map_8panels_"

# Set figure
fig, axes = plt.subplots(2, 4, sharex=True, sharey=True, constrained_layout=True, figsize=(14, 7))
axs = [axes[0, 0], axes[0, 1], axes[0, 2], axes[0, 3],
...
cbar = fig.colorbar(im, ax=[axs[3], axs[7]], shrink=0.87, aspect=30)  # colorbar to the right of figure
