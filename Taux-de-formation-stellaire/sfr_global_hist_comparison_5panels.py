...
runs = [["ISOL8_h", "TIDES8_h_p_mm"], ["ISOL8_h", "TIDES8_h_p2_mm"], ["ISOL8_h", "TIDES8_h_p3_mm"],
        ["ISOL8_h", "TIDES8_h_a"], ["ISOL8_h", "TIDES8_h_a2"]]
sburst = [[0.2, 1.1], [0.2, 1.3], [0.2, 1.4], [0.4, 1.5], [0.8, 1.6, 1.7, 4.6]]
...
# Figure setting
fig, axs = plt.subplots(2, 3, sharey=True, constrained_layout=True, figsize=(11, 7))
