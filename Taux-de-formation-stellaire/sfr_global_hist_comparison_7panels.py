...
runs = [["ISOL8_h", "TIDES8_h"], ["ISOL8_h", "TIDES8_h_a"], ["ISOL8_h", "TIDES8_h_a2"],
        ["ISOL8_h", "TIDES8_h_a3"], ["ISOL8_h", "TIDES8_h_a4"], ["ISOL8_h", "TIDES8_h_r"], ["ISOL8_h", "TIDES8_h_r2"]]
sburst = [[0.8, 2.0], [0.4, 1.4], [0.8, 1.6, 1.6, 4.6], [], [], [0.2, 1.2], [0.8, 1.8, 2.0, 4.6]]
...
# Figure setting
fig, axs = plt.subplots(3, 3, sharey=True, constrained_layout=True, figsize=(11, 11))
axes = [axs[0, 0], axs[0, 1], axs[0, 2], axs[1, 0], axs[1, 1], axs[1, 2], axs[2, 0]]
...
for ax in range(4, len(axes)):
    axes[ax].set_xlabel(x_label)
axs[0, 0].set_ylabel(y_label), axs[1, 0].set_ylabel(y_label), axs[2, 0].set_ylabel(y_label)
#axs[0, 1].set_yticklabels([]), axs[0, 2].set_yticklabels([]), axs[1, 1].set_yticklabels([]), axs[1, 2].set_yticklabels([])
# for ax in axs.flat:
...
# axs[1, 1].set_xlabel(x_label), axs[1, 2].set_xlabel(x_label)
# axs[1, 1].set_xticks(time_n), axs[1, 2].set_xticks(time_n)
# axs[1, 1].set_xticklabels(axs[2, 0].get_xticklabels()), axs[1, 2].set_xticklabels(axs[2, 0].get_xticklabels())
